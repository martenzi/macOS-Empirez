...
#   ~/.zshrc
#
# ZSH Shell initialization script. That's functions, aliases, zsh-only variables
#
#   Henrik Mårtenzon
#       ~Martenzi
...
# To activate zsh-completions (via homebrew), add the following to your .zshrc:
...
# ALIASSES - FILESYSTEM   #
#-------------------------#
alias mate="mate ~/.zshrc"
alias ohmate="mate ~/.zshrc.pre-oh-my-zsh"
...
alias findex='type -all'                     		# which:        Find executables
